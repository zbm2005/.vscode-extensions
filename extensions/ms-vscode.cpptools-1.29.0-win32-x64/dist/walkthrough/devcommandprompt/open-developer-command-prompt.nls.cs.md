...
<li><p data-loc-id="walkthrough.open.command.prompt">Otevřete <span>Developer Command Prompt for VS</span> zadáním „<code>developer</code>“ v nabídce Start ve Windows. Vyberte <span>Developer Command Prompt for VS</span>, čímž automaticky přejdete do aktuální otevřené složky.</p>
</li>
<li><p data-loc-id="walkthrough.windows.press.f5">Do příkazového řádku zadejte „<code>code</code>“ a stiskněte Enter. Mělo by se znovu spustit VS Code a vrátit se k tomuto názorném postupu. </p>
</li>
</ol>