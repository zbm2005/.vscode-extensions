...
<li><p data-loc-id="walkthrough.open.command.prompt">Abra o <span>Developer Command Prompt for VS</span> digitando "<code>developer</code>" no menu Iniciar do Windows. Selecione o <span>Developer Command Prompt for VS</span>, que navegará automaticamente para a pasta atualmente aberta.</p>
</li>
<li><p data-loc-id="walkthrough.windows.press.f5">Digite "<code>code</code>" na solicitação de comando e pressione enter. Isso deve relançar o VS Code e levá-lo de volta a este tutorial. </p>
</li>
</ol>