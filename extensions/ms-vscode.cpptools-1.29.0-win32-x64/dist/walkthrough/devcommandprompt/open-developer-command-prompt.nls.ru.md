...
<li><p data-loc-id="walkthrough.open.command.prompt">Откройте <span>Developer Command Prompt for VS</span>, введя "<code>developer</code>" в меню "Пуск" в Windows. Выберите <span>Developer Command Prompt for VS</span>. Вы автоматически перейдете к текущей открытой папке.</p>
</li>
<li><p data-loc-id="walkthrough.windows.press.f5">Введите "<code>code</code>" в командную строку и нажмите ВВОД. Это должно перезапустить VS Code и вернуть вас к этому пошаговому руководству. </p>
</li>
</ol>