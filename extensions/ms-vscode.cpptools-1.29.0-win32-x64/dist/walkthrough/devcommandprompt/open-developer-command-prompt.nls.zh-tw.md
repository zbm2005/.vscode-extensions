...
<li><p data-loc-id="walkthrough.open.command.prompt">在 Windows [開始] 功能表中輸入 "<code>developer</code>"，以開啟 <span>Developer Command Prompt for VS</span>。選取 <span>Developer Command Prompt for VS</span>，這會自動瀏覽至您目前開啟的資料夾。</p>
</li>
<li><p data-loc-id="walkthrough.windows.press.f5">在命令提示字元中輸入 "<code>code</code>"，然後按 Enter。這應該會重新啟動 VS Code，並帶您回到此逐步解說。</p>
</li>
</ol>